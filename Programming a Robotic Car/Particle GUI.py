...
if __name__ == "__main__":
    ...
    motions = [[(random.random()*2*pi - pi)/5, 10] for row in range(number_of_iterations)]

    #Display window
    wind = DispParticleFilter ( motions, 1000, 0.1, displayRealRobot = True, displayGhost = True )
    wind.mainloop()

...
def runSimulation(num_robots, speed, width, height, min_coverage, num_trials,
    ...
    for _ in range(num_trials):
        ...
        time_steps.append(current_time_steps)
    # anim.done()
...
# showPlot1("Avg steps for x robots to clean 80% of a 20x20 room", "# of robots", "# of steps")
...
showPlot2("# of steps for 2 robots to clean 80% of rooms with the same area but different aspect ratios",
          "Aspect ratio", "# of steps")

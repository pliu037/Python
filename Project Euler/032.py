...
have too many digits). Potential products are generated by permuting combinations of 4 digits to
ensure unique digits. Factoring is used to find multiplicand/multiplier pairs that yield the
potential product.
'''
def findSumPandigitalProducts():
    ...
    for combo in combos:
        ...
        for perm in perms:
            ...
            '''
            Optimization: If check < 2000, check/2 < 1000 and the multiplicand and multiplier would
            no longer have enough digits (1 + 3 < 9 - 4 = 5).
            '''
            if check >= 2000:
